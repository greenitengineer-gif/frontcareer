...
exports.aiSearch = exports.checkJobMatch = void 0;
...
const checkJobMatch = async (req, res) => {
    try {
        ...
        const result = await (0, ai_1.calculateMatchScore)(jobId, cvId, cvData);
        res.json(result);
    }
    catch (error) {
...
exports.checkJobMatch = checkJobMatch;
